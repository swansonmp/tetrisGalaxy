public class SBlock
{
    ...
    public static void spinRight(Block lead)
    {
        ...
        {
            case 0:
                if (lead.getBase().augmentCheck(1,0) && lead.getBase().augmentCheck(1,1))
                {
                    lead.getOne().augment(1,-1);
                    lead.getTwo().augment(1,1);
                    lead.getThree().augment(0,2);
                    lead.incrementRot();
                }
                break;
            case 1:
                if (lead.getBase().augmentCheck(-1,1) && lead.getBase().augmentCheck(0,1))
                {
                    lead.getOne().augment(1,1);
                    lead.getTwo().augment(-1,1);
                    lead.getThree().augment(-2,0);
                    lead.incrementRot();
                }
                break;
            case 2:
                ...
                break;
            case 3:
                if (lead.getBase().augmentCheck(0,-1) && lead.getBase().augmentCheck(1,-1))
                {
                    lead.getOne().augment(-1,-1);
                    lead.getTwo().augment(1,-1);
                    lead.getThree().augment(2,0);
    ...
    public static void spinLeft(Block lead)
    {
        switch(lead.getState())
        {
            ...
            case 2:
                ...
                break;
            case 3:
                if (lead.getBase().augmentCheck(-1,-1) && lead.getBase().augmentCheck(-1,0))
                {
                    lead.getOne().augment(1,-1);
                    lead.getTwo().augment(1,1);
                    lead.getThree().augment(0,2);
